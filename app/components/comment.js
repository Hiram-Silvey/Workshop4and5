...
export default class Comment extends React.Component {
  ...
  render() {
    ...
    return (
	  ...
	  {this.props.children}
      <br /><a href="#" onClick={(e) => this.handleLikeClick(e)}>{likeButtonText}</a> · <a href="#">Reply</a> · <span className="glyphicon glyphicon-thumbs-up"></span>{this.state.likeCounter.length} · 
