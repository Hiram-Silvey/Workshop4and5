        ...
        return (
                ...
                <CommentThread onPost={(commentText) => this.handleCommentPost(commentText)} >
                {
                    data.comments.map((comment, i) => {
                        ...
                        return (
                            <Comment feedItemId={this.state._id} commentId={i} key={i} author={comment.author} postDate={comment.postDate} likeCounter={comment.likeCounter}>{comment.contents}</Comment>
                            );
                    })
                }
        </CommentThread>
